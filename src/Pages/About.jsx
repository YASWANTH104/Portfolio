    ...
    >
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          <img
            src="https://res-console.cloudinary.com/dpxtbouej/thumbnails/v1/image/upload/v1757748482/U25hcGNoYXQtNzIwMTcxMDJfeW9weGYz/drilldown"
            alt="Profile"
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        ...
        Driven by curiosity, creativity, and clean code.
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1oyutXX_iVWVcyYmzdE6LjO2THnkxiPG6/view?usp=sharing" className="w-full lg:w-auto" target="_blank">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
