...
import { Github, Linkedin, Mail, ExternalLink, Phone, Sparkles,Code } from "lucide-react"
...
const WORDS = ["Driven by code, powered by curiosity", "Tech Enthusiast"];
const TECH_STACK = ["React","JavaScript", "Python","Typescript", "Node.js", "Tailwind","Express.js", "MongoDB","FastAPI","Bootstrap","Shadcn UI","C++","SQLite3"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/YASWANTH104" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/yaswanth-sai-gonuguntla" },
  { icon: Code, link: "https://leetcode.com/u/yaswanth_104/" },
{icon:Phone,link:"tel:+919640004455"}
