...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/yaswanth-sai-gonuguntla",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@yaswanth_sai",
    icon: Instagram,
    url: "https://www.facebook.com/yaswanthsai.gonuguntla",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@yaswanth_104",
    icon: Code,
    url: "https://leetcode.com/u/yaswanth_104/",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@yaswanth104",
    icon: Github,
    url: "https://github.com/YASWANTH104",
    color: "#ffffff",
  ...
  displayName: "Call Me",
  subText: "on Mobile",
  icon: Phone, // Make sure you have a Phone icon component imported
  url: "tel:+919640004455", // Use 'tel:' link for phone numbers
  color: "#34A853", // A suitable green for phone
